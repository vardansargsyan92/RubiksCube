...
class Util {
	...
	//Colors
	static final byte U = 0; //white
	static final byte R = 1; //orange
	static final byte F = 2; //blue
	static final byte D = 3; //yellow
	static final byte L = 4; //red
	static final byte B = 5; //green
	...
	static String[] move2str = {
			"U", "U U", "Ui", "R", "R R", "Ri", "F", "F F", "Fi",
			"D", "D D", "Di", "L", "L L", "Li", "B", "B B", "Bi"
	};
